...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///all_cardekho_listings_fuzzy.db'  # Replace with your database name
...
@app.route('/api/cardekho_any', methods=['GET'])
def get_all_tables():
    ...
    mumbai_url = "http://127.0.0.1:9260/api/cardekho_mumbai"
    response_mumbai = requests.get(mumbai_url, params=params)

    pune_url = "http://127.0.0.1:9260/api/cardekho_pune"

    response_pune = requests.get(pune_url, params=params)

    hyderabad_url = "http://127.0.0.1:9260/api/cardekho_hyderabad"
    response_hyderabad = requests.get(hyderabad_url, params=params)

    bangalore_url = "http://127.0.0.1:9260/api/cardekho_bangalore"
    response_bangalore = requests.get(bangalore_url, params=params)

    delhi_url = "http://127.0.0.1:9260/api/cardekho_delhi"
...
# Define API endpoints to interact with each table
@app.route('/api/cardekho_mumbai', methods=['GET'])
def get_table1():
    # data = cardekho_mumbai.query.all()
    ...
    query = 'SELECT * FROM cardekho_mumbai_fts WHERE '  # Placeholder condition that is always true
    results = ""
    params = {}
...
@app.route('/api/cardekho_delhi', methods=['GET'])
def get_table2():
    # data = cardekho_delhi.query.all()
    ...
    print(model)
    print(fuel_type, location, year, kms_driven)
    query = 'SELECT * FROM cardekho_delhi_fts WHERE '  # Placeholder condition that is always true
    results = ""
    params = {}
...
@app.route('/api/cardekho_hyderabad', methods=['GET'])
def get_table3():
    # data = cardekho_delhi.query.all()
    ...
    print(model)
    print(fuel_type, location, year, kms_driven)
    query = 'SELECT * FROM cardekho_hyderabad_fts WHERE '  # Placeholder condition that is always true
    results = ""
    params = {}
    # Step 0 match company
    if company:
...
@app.route('/api/cardekho_bangalore', methods=['GET'])
def get_table4():
    # data = cardekho_bangalore.query.all()
    ...
    print(model)
    print(fuel_type, location, year, kms_driven)
    query = 'SELECT * FROM cardekho_bangalore_fts WHERE '  # Placeholder condition that is always true
    results = ""
    params = {}
    # Step 0 match company
    if company:
...
@app.route('/api/cardekho_pune', methods=['GET'])
def get_table5():
    # data = cardekho_pune.query.all()
    ...
    print(model)
    print(fuel_type, location, year, kms_driven)
    query = 'SELECT * FROM cardekho_pune_fts WHERE '  # Placeholder condition that is always true
    results = ""
    params = {}
    # Step 0 match company
    if company:
