...
# Example usage:
csv_file_path = 'spinny_mumbai.csv'  # Replace with the actual path to your CSV file
...
# Example usage:
input_file_path = 'spinny_mumbai.csv'  # Replace with the actual path to your input CSV file
output_file_path = 'separated_csvs/spinny_mumbai_separated.csv'  # Replace with the desired output file path
