...
# Example usage:
csv_file_path = 'cars24_newdelhi.csv'  # Replace with the actual path to your CSV file
...
# Example usage:
input_file_path = 'cars24_newdelhi.csv'  # Replace with the actual path to your input CSV file
output_file_path = 'separated_csvs/cars24_newdelhi_separated.csv'  # Replace with the desired output file path
