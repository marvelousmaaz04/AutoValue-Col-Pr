...
# List of file names
file_names = ['olx_mumbai.csv', 'olx_bangalore.csv', 'olx_delhi.csv', 'olx_hyderabad.csv', 'olx_pune.csv']
...
combined_data.to_csv('all_olx_data.csv', index=False)

print("Files combined successfully. Output saved to 'all_olx_data.csv'")
